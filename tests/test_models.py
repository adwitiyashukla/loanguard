...
from src.models import XGBFraudModel, LGBMFraudModel, IsolationForestFraudModel

@pytest.fixture
def small_features(small_df):
    y = small_df['is_fraud']
    drop = ['is_fraud', 'rule_fpd', 'rule_income_anomaly', 'rule_debt_inconsist', 'rule_address_ring', 'n_anomalies', 'loan_status', 'last_pymnt_d']
