...
def test_score_returns_503_when_model_not_loaded():
    payload = {'loan_amnt': 10000, 'term': 36, 'int_rate': 12.5, 'installment': 334.5, 'grade': 'B', 'sub_grade': 'B3', 'annual_inc': 50000, 'dti': 18.0, 'purpose': 'debt_consolidation', 'zip_code': '941xx', 'addr_state': 'CA', 'revol_util': 30.0, 'revol_bal': 5000, 'open_acc': 5, 'total_acc': 12}
